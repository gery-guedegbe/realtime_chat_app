  ...
  return (
    <main className="flex h-screen max-h-screen flex-col overflow-hidden">
      <header className="flex items-center justify-between border-b border-zinc-800 bg-zinc-900/30 p-4">
        <div className="flex items-center gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={copyLink}
                className="cursor-pointer rounded bg-zinc-800 px-2 py-0.5 text-[10px] text-zinc-200 transition-colors hover:bg-zinc-700"
              >
                {copyStatus}
              </button>
            </div>
        ...
        <button
          onClick={() => destroyRoom()}
          className="group flex cursor-pointer items-center gap-2 rounded bg-zinc-800 px-3 py-1.5 text-xs font-bold text-zinc-400 transition-all hover:bg-red-600 hover:text-white disabled:opacity-50"
        >
